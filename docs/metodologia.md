...
description: "Fundamento metodológico del Índice de Visibilidad en Inteligencia Artificial"
version: "1.0"
date: "2026-05-01"
...
Su utilidad no está en el número absoluto de un solo ciclo sino en la evolución entre ciclos. Un IVIA de 64 en abril no dice "visibilidad alta". Dice "este es el punto de partida verificable". El siguiente ciclo dirá si la implementación movió la aguja y en qué dimensión.
...
- **v1.0** (actual): fórmula base con cuatro dimensiones, validación en un solo modelo (Gemini)
- **v1.1**: protocolo de tres evaluadores para dimensión PR
- **v2.0**: segmentación por modelo (IVIA-G, IVIA-C, IVIA-P), normalización cross-model
- **v3.0**: validación con dataset multi-entidad, posible ajuste de ponderaciones basado en evidencia acumulada
